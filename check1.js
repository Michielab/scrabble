...
//   if(document.getElementById(parseInt(checkWordLeftToRightArray[i]) -2).hasChildNodes()); {
//     console.log('test');
//
//   }
//
...
// if(document.getElementById(checkWordLeftToRightArray[i -2]).hasChildNodes()) {
// if(document.getElementById(checkWordLeftToRightArray[i -3]).hasChildNodes()) {
// if(document.getElementById(checkWordLeftToRightArray[i -4]).hasChildNodes()) {
// if(document.getElementById(checkWordLeftToRightArray[i -5]).hasChildNodes()) {
// if(document.getElementById(checkWordLeftToRightArray[i -6]).hasChildNodes()) {
// if(document.getElementById(checkWordLeftToRightArray[i -7]).hasChildNodes()) {
// if(document.getElementById(checkWordLeftToRightArray[i -8]).hasChildNodes()) {
// }
//
// }
//
...
//
// if(document.getElementById(parseInt(idParentDiv) - 1).hasChildNodes()){
//   console.log(idParentDiv);


// for(var i = parseInt(data); i > parseInt(data) && document.getElementById(parseInt(idParentDiv) + 1).hasChildNodes(); i++) {
//   wordsCheck[i].push(data + valueSpanElement);
// }
